...
[google-cloud-java/java-speech](
https://github.com/googleapis/google-cloud-java/tree/main/java-speech).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-speech`) remain the same.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-speech/4.7.0
